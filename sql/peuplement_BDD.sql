...
INSERT INTO artisan (nom, note, ville, a_propos, email, site_web, top_artisan, id_specialite) VALUES
    ...
    ('Mont Blanc Électricité', 4.5, 'Chamonix', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'contact@mont-blanc-electricite.com', 'https://mont-blanc-electricite.com', FALSE, 6),
    ...
    ('Ernest Carignan', 5.0, 'Le Puy-en-Velay', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'e.carignan@hotmail.com', NULL, FALSE, 11),

    ('Royden Charbonneau', 3.8, 'Saint-Priest', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'r.charbonneau@gmail.com', 'https://coiffure-leala-chambery.fr', FALSE, 12),
    ('Leala Dennis', 3.8, 'Chambéry', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'l.dennis@hotmail.fr', NULL, FALSE, 12),
